...
program
	...
	.option("--plugins <names>", "Plugin names (@citation-js/plugin-NAME); bibjson, bibtex, csl, doi, ris & wikidata are preloaded", (names) => names.split(","), [])
	.option("--plugin-config <config>", "@plugin.property.path=value;...", splitOptions, [])
	.option("--formatter-options <config>", "property.path=value;...", splitOptions, [])
