			...
			describe("class", function () {
				...
				describe("dataType", function () {
					...
					describe("values", function () {
						it("String", () => {
							expect(plugins.input.util.dataTypeOf("foo")).to.be("String");
						});
						it("Array", () => {
							expect(plugins.input.util.dataTypeOf([])).to.be("Array");
						});
						it("SimpleObject", () => {
							expect(plugins.input.util.dataTypeOf({})).to.be("SimpleObject");
						});
						it("ComplexObject", () => {
							expect(plugins.input.util.dataTypeOf(/foo/)).to.be("ComplexObject");
						});
						it("Primitive", () => {
							expect(plugins.input.util.dataTypeOf(null)).to.be("Primitive");
						});

						describe("typeOf", function () {
							it("Undefined", () => {
								expect(plugins.input.util.typeOf(undefined)).to.be("Undefined");
							});
							it("Null", () => {
								expect(plugins.input.util.typeOf(null)).to.be("Null");
							});
							it("primitive literal", () => {
								expect(plugins.input.util.typeOf("")).to.be("String");
							});
							it("Object", () => {
								expect(plugins.input.util.typeOf({})).to.be("Object");
							});
						});
					});
				});
